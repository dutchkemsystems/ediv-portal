...
class DepartmentModelTest(TestCase):
    def setUp(self):
        self.user = User.objects.create_user(
            email="head@test.com", password="TestPass123!", first_name="Head", last_name="User", role="HR"
        )
        self.dept = Department.objects.create(name="Human Resources", code="HR", category="CORE", head=self.user)

    def test_department_str(self):
        self.assertEqual(str(self.dept), "Human Resources (HR)")

    def test_department_hierarchy(self):
        sub = Department.objects.create(name="Recruitment", code="HR-REC", category="SUPPORT", parent=self.dept)
...
class UnitModelTest(TestCase):
    def setUp(self):
        ...
        self.unit = Unit.objects.create(name="Accounts", code="FIN-ACC", department=self.dept)
...
class DepartmentAPITest(APITestCase):
    def setUp(self):
        ...
        self.dept = Department.objects.create(name="QA", code="QA", category="CORE")
    ...
    def test_create_department(self):
        response = self.client.post(
            "/api/departments/departments/", {"name": "New Dept", "code": "NEW", "category": "SUPPORT"}
        )
    ...
    def test_update_department(self):
        response = self.client.patch(f"/api/departments/departments/{self.dept.id}/", {"description": "Updated"})
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_create_unit(self):
        response = self.client.post(
            "/api/departments/units/", {"name": "New Unit", "code": "NU", "department": self.dept.id}
        )
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
