...
class CourseModuleModelTest(TestCase):
    def setUp(self):
        ...
        self.course = Course.objects.create(
            school=school, title="Algebra", code="ALG", description="Algebra course", subject=subject, instructor=user
        )
        self.module = CourseModule.objects.create(course=self.course, title="Introduction", order=1)
