...
from .models import FrenchClub, FrenchProgram
...
class FrenchProgramModelTest(TestCase):
    def setUp(self):
        self.program = FrenchProgram.objects.create(
            name="Beginner French", description="Intro to French", level="BEGINNER", duration_weeks=12
        )
...
class FrenchClubModelTest(TestCase):
    def setUp(self):
        ...
        self.club = FrenchClub.objects.create(school=self.school, name="French Conversation Club")
