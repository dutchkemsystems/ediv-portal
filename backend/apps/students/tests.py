...
class StudentModelTest(TestCase):
    def setUp(self):
        self.school = School.objects.create(
            name="Test School", code="TS001", school_type="SENIOR", lga="APAPA", address="123 Street"
        )
        self.user = User.objects.create_user(
            email="student@test.com", password="TestPass123!@#", first_name="Jane", last_name="Smith", role="STD"
        )
    ...
    def test_student_age(self):
        ...
        today = date.today()
        expected_age = today.year - 2005 - ((today.month, today.day) < (1, 15))
...
class StudentAPITest(APITestCase):
    def setUp(self):
        ...
        self.student_user = User.objects.create_user(
            email="student@test.com", password="StudentPass123!@#", first_name="Jane", last_name="Smith", role="STD"
        )
        self.student = Student.objects.create(
    ...
    def test_create_student(self):
        new_user = User.objects.create_user(
            email="newstudent@test.com", password="StudentPass123!@#", first_name="New", last_name="Student", role="STD"
        )
        data = {
            "user_id": new_user.id,
