...
class PushNotification(models.Model):
    ...
    target_users = models.ManyToManyField(settings.AUTH_USER_MODEL, blank=True, related_name="push_notifications")
    target_roles = models.JSONField(default=list, help_text="Target specific roles")
    target_schools = models.ManyToManyField("schools.School", blank=True, related_name="push_notifications")
    ...
    created_by = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, related_name="created_notifications"
    )
    created_at = models.DateTimeField(auto_now_add=True)
