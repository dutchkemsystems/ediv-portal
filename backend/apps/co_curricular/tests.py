...
class ActivityModelTest(TestCase):
    def setUp(self):
        ...
        self.activity = Activity.objects.create(
            school=self.school, name="Football Club", activity_type="SPORTS", description="School football team"
        )
...
class CoCurricularAPITest(APITestCase):
    ...
    def test_create_activity(self):
        response = self.client.post(
            ...
            {"school": self.school.id, "name": "Chess Club", "activity_type": "CLUB", "description": "Chess club"},
        )
