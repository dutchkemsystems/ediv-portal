...
class SchoolBenchmark(models.Model):
    school = models.ForeignKey("schools.School", on_delete=models.CASCADE, related_name="benchmarks")
    metric = models.ForeignKey(BenchmarkMetric, on_delete=models.CASCADE, related_name="school_benchmarks")
...
class BenchmarkComparison(models.Model):
    school_a = models.ForeignKey("schools.School", on_delete=models.CASCADE, related_name="comparisons_as_a")
    school_b = models.ForeignKey("schools.School", on_delete=models.CASCADE, related_name="comparisons_as_b")
