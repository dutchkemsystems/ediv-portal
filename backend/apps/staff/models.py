...
class Staff(models.Model):
    ...
    department = models.ForeignKey(
        "departments.Department", on_delete=models.SET_NULL, null=True, blank=True, related_name="staff_members"
    )
...
class StaffPerformance(models.Model):
    ...
    reviewed_by = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, related_name="performance_reviews"
    )
