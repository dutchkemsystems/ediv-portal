...
def _create_staff_user(email="staff@test.com", **overrides):
    ...
    defaults = dict(email=email, password="TestPass123!", first_name="John", last_name="Doe", role="TCH")
...
class StaffAPITest(APITestCase):
    ...
    def test_create_staff(self):
        new_user = User.objects.create_user(
            email="new@test.com", password="TestPass123!", first_name="New", last_name="Staff", role="TCH"
        )
