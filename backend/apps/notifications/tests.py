...
class NotificationTemplateModelTest(TestCase):
    def setUp(self):
        self.template = NotificationTemplate.objects.create(
            name="Welcome", subject="Welcome!", body="Hello {{name}}", channel="EMAIL"
        )
...
class NotificationLogModelTest(TestCase):
    def setUp(self):
        ...
        self.log = NotificationLog.objects.create(
            template=self.template, recipient=self.user, channel="IN_APP", subject="Alert!", body="Alert body"
        )
...
class NotificationAPITest(APITestCase):
    def setUp(self):
        ...
        self.template = NotificationTemplate.objects.create(name="Test", subject="Test", body="Body", channel="IN_APP")
