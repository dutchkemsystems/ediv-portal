...
class EarlyWarningAlert(models.Model):
    ...
    risk_profile = models.ForeignKey(StudentRiskProfile, on_delete=models.CASCADE, related_name="alerts")
    ...
    acknowledged_by = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name="acknowledged_warnings"
    )
...
class Intervention(models.Model):
    ...
    student = models.ForeignKey("students.Student", on_delete=models.CASCADE, related_name="interventions")
    alert = models.ForeignKey(
        EarlyWarningAlert, on_delete=models.SET_NULL, null=True, blank=True, related_name="interventions"
    )
...
class RiskTrend(models.Model):
    ...
    student = models.ForeignKey("students.Student", on_delete=models.CASCADE, related_name="risk_trends")
