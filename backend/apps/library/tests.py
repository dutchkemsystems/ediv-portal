...
class BookLoanModelTest(TestCase):
    def setUp(self):
        ...
        self.book = Book.objects.create(
            school=school, title="Test Book", author="Author", isbn="978-0000000001", category="FICTION"
        )
        ...
        self.loan = BookLoan.objects.create(
            book=self.book, borrower=self.user, loan_date="2026-01-01", due_date="2026-01-15"
        )
