...
class SchoolModelTest(TestCase):
    def setUp(self):
        self.user = User.objects.create_user(
            email="principal@school.com", password="TestPass123!@#", first_name="John", last_name="Doe", role="PRI"
        )
    ...
    def test_school_unique_code(self):
        with self.assertRaises(Exception):
            School.objects.create(
                name="Another School", code="TSS001", school_type="JUNIOR", lga="MAINLAND", address="456 Another Street"
            )
...
class SchoolAPITest(APITestCase):
    def setUp(self):
        ...
        self.school = School.objects.create(
            name="Test Secondary School", code="TSS001", school_type="SENIOR", lga="APAPA", address="123 Test Street"
        )
