    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "attendees_parents",
                    models.ManyToManyField(blank=True, related_name="pta_attendees", to=settings.AUTH_USER_MODEL),
                ),
                (
                    "organized_by",
                    models.ForeignKey(
                ...
                (
                    "school",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="pta_meetings", to="schools.school"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "student",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="pt_messages", to="students.student"
                    ),
                ),
            ],
            options={
