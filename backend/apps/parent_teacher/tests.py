...
from .models import ParentTeacherMessage, PTAMeeting
...
class PTAMeetingModelTest(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            email="principal@test.com", password="TestPass123!", first_name="Principal", last_name="One", role="PRI"
        )
        self.meeting = PTAMeeting.objects.create(
            title="Q1 PTA Meeting",
...
class ParentTeacherMessageModelTest(TestCase):
    def setUp(self):
        self.teacher = User.objects.create_user(
            email="teacher@test.com", password="TestPass123!", first_name="Teacher", last_name="One", role="TCH"
        )
        self.parent = User.objects.create_user(
            email="parent@test.com", password="TestPass123!", first_name="Parent", last_name="One", role="PAR"
        )
        from apps.schools.models import School
        ...
        self.student = Student.objects.create(
            user=User.objects.create_user(
                email="student@test.com", password="TestPass123!", first_name="Student", last_name="One", role="STD"
            ),
