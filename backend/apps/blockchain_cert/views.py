...
from .serializers import CertificateSerializer, VerifyCertificateRequestSerializer
...
class CertificateViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        block_data = CertificateBlockchain.generate_certificate_data(
            instance.student, instance.school, instance.certificate_type, instance.title, instance.issued_date
        )
        ...
        return Response(
            {
                ...
                "message": (
                    ...
                    if is_valid and not cert.is_revoked
