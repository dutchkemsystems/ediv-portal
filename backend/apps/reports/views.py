...
from .serializers import DashboardListSerializer, DashboardSerializer, ReportSerializer, WidgetSerializer
...
class ReportViewSet(viewsets.ModelViewSet):
    ...
    def import_data(self, request):
        ...
        try:
            ...
            return Response({"success": True, "data": result, "validation": validation})
...
class DashboardViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return Dashboard.objects.filter(models.Q(owner=user) | models.Q(is_default=True)).distinct()
