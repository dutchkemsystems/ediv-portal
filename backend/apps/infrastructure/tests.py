...
class FacilityModelTest(TestCase):
    def setUp(self):
        ...
        self.facility = Facility.objects.create(
            school=self.school, name="Main Hall", facility_type="HALL", capacity=500, condition="GOOD"
        )
...
class MaintenanceRequestModelTest(TestCase):
    def setUp(self):
        ...
        self.facility = Facility.objects.create(school=school, name="Lab", facility_type="LABORATORY")
        self.user = User.objects.create_user(
            email="test@test.com", password="TestPass123!", first_name="Test", last_name="User", role="TCH"
        )
...
class InfrastructureAPITest(APITestCase):
    ...
    def test_create_facility(self):
        response = self.client.post(
            ...
            {"school": self.school.id, "name": "New Lab", "facility_type": "LABORATORY", "capacity": 40},
        )
