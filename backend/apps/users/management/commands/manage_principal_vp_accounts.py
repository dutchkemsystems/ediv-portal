...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for school in schools:
            if school.principal:
                principals.append({"user": school.principal, "school": school, "type": "Principal"})
            if school.vice_principal:
                vice_principals.append({"user": school.vice_principal, "school": school, "type": "Vice Principal"})
        ...
        if list_only:
            ...
            for item in all_users:
                ...
                self.stdout.write(f"{user.email:<45} {role_display:<20} {full_name:<30} {school.code:<15} {active}")
