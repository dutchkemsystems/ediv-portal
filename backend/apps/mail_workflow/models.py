...
class IncomingMail(models.Model):
    ...
    received_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="received_mails")
...
class MailAssignment(models.Model):
    ...
    assigned_by = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="mail_assignments_made"
    )
    assigned_to = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="mail_assignments_received"
    )
...
class OutgoingMailApproval(models.Model):
    ...
    approver = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="outgoing_mail_approvals"
    )
...
class OutgoingMailMovement(models.Model):
    ...
    from_person = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="outgoing_mail_sent"
    )
    to_person = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="outgoing_mail_received",
    )
    action = models.CharField(max_length=100)
    remarks = models.TextField(blank=True)
    movement_date = models.DateTimeField(auto_now_add=True)
    ...
    def __str__(self):
        return f"{self.outgoing_mail.mail_number}: {self.from_person.get_full_name()} -> {self.to_person.get_full_name() if self.to_person else 'N/A'}"  # noqa: E501
...
class SchoolHQCorrespondence(models.Model):
    ...
    department = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="school_correspondences",
    )
    ...
    recipient = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="received_hq_correspondences",
    )
    date_created = models.DateField(auto_now_add=True)
...
class SchoolHQCorrespondenceMovement(models.Model):
    ...
    from_person = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="hq_correspondence_sent"
    )
    to_person = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name="hq_correspondence_received",
    )
    action = models.CharField(max_length=100)
    remarks = models.TextField(blank=True)
    movement_date = models.DateTimeField(auto_now_add=True)
    ...
    def __str__(self):
        return f"{self.correspondence.reference_number}: {self.from_person.get_full_name()} -> {self.to_person.get_full_name() if self.to_person else 'N/A'}"  # noqa: E501
...
class MailCorrespondence(models.Model):
    ...
    subject = models.CharField(max_length=300)
    sender = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="sent_correspondences")
    recipient = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.SET_NULL,
        null=True,
...
class MailCorrespondenceMovement(models.Model):
    ...
    from_person = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="correspondence_sent"
    )
    to_person = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name="correspondence_received",
    )
    action = models.CharField(max_length=100)
    remarks = models.TextField(blank=True)
    movement_date = models.DateTimeField(auto_now_add=True)
