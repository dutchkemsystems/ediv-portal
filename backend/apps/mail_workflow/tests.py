...
from .models import IncomingMail, MailCorrespondence, OutgoingMail
...
class IncomingMailModelTest(TestCase):
    def setUp(self):
        self.user = User.objects.create_user(
            email="reg@test.com", password="TestPass123!", first_name="Registry", last_name="Officer", role="REG_OFF"
        )
        self.mail = IncomingMail.objects.create(
            mail_number="IM-2026-001",
