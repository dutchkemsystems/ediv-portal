...
class TemplateServiceCreateTest(TestCase):
    ...
    def setUp(self):
        ...
        self.department = Department.objects.create(name="Admin", code="ADM", category="CORE")
...
class TemplateServiceUpdateTest(TestCase):
    ...
    def test_update_template_name(self):
        ...
        updated = TemplateService.update_template(template=self.template, name="Updated Name")
    ...
    def test_update_template_description(self):
        ...
        updated = TemplateService.update_template(template=self.template, description="Updated description")
        self.assertEqual(updated.description, "Updated description")

    def test_update_template_category(self):
        """Update template category."""
        updated = TemplateService.update_template(template=self.template, category="MEMO")
    ...
    def test_update_template_returns_same_instance(self):
        ...
        updated = TemplateService.update_template(template=self.template, name="Same Instance")
...
class TemplateServiceGenerateFileTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email="genuser@ediv.gov.ng", password="TestPass123!@#", first_name="Gen", last_name="User", role="SYSADMIN"
        )
        self.department = Department.objects.create(name="Academics", code="ACD", category="CORE")
        self.template = FileTemplate.objects.create(
