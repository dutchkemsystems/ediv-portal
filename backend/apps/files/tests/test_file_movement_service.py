...
class FileMovementServiceCreateFileTest(TestCase):
    ...
    def setUp(self):
        ...
        self.department = Department.objects.create(name="Finance", code="FIN", category="CORE")
        cache.clear()
...
class FileMovementServiceMoveFileTest(TestCase):
    ...
    def setUp(self):
        self.user1 = User.objects.create_user(
            email="user1@ediv.gov.ng", password="TestPass123!@#", first_name="User", last_name="One", role="SYSADMIN"
        )
        self.user2 = User.objects.create_user(
            email="user2@ediv.gov.ng", password="TestPass123!@#", first_name="User", last_name="Two", role="TCH"
        )
...
class FileMovementServiceCacheTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email="cache@ediv.gov.ng", password="TestPass123!@#", first_name="Cache", last_name="User", role="SYSADMIN"
        )
        self.file = File.objects.create(
