...
class ImportExportServiceImportUnsupportedTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email="bad@ediv.gov.ng", password="TestPass123!@#", first_name="Bad", last_name="User", role="SYSADMIN"
        )
...
class ImportExportServiceBulkImportTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email="bulk@ediv.gov.ng", password="TestPass123!@#", first_name="Bulk", last_name="User", role="SYSADMIN"
        )
...
class ImportExportServiceImportErrorHandlingTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email="error@ediv.gov.ng", password="TestPass123!@#", first_name="Error", last_name="User", role="SYSADMIN"
        )
