...
class NotificationServiceSendNotificationTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email="notif@test.gov.ng", password="TestPass123!@#", first_name="Notif", last_name="User", role="TCH"
        )
...
class NotificationServiceEscalatedTest(TestCase):
    ...
    def setUp(self):
        self.user1 = User.objects.create_user(
            email="user1@test.gov.ng", password="TestPass123!@#", first_name="User", last_name="One", role="SYSADMIN"
        )
        self.user2 = User.objects.create_user(
            email="user2@test.gov.ng", password="TestPass123!@#", first_name="User", last_name="Two", role="TCH"
        )
...
class NotificationServiceDeadlineTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email="holder@test.gov.ng", password="TestPass123!@#", first_name="Holder", last_name="User", role="TCH"
        )
...
class NotificationServiceGetNotificationsTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email="getnotif@test.gov.ng", password="TestPass123!@#", first_name="Get", last_name="Notif", role="TCH"
        )
...
class NotificationServiceMarkReadTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email="markread@test.gov.ng", password="TestPass123!@#", first_name="Mark", last_name="Read", role="TCH"
        )
...
class SearchServiceSearchMovementsTest(TestCase):
    ...
    def setUp(self):
        self.user1 = User.objects.create_user(
            email="mov1@test.gov.ng", password="TestPass123!@#", first_name="Mov1", last_name="User", role="SYSADMIN"
        )
        self.user2 = User.objects.create_user(
            email="mov2@test.gov.ng", password="TestPass123!@#", first_name="Mov2", last_name="User", role="TCH"
        )
        self.file = File.objects.create(
...
class OfflineSyncServiceQueueActionTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email="offline@test.gov.ng", password="TestPass123!@#", first_name="Offline", last_name="User", role="TCH"
        )
...
class OfflineSyncServicePendingCountTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email="count@test.gov.ng", password="TestPass123!@#", first_name="Count", last_name="User", role="TCH"
        )
    ...
    def test_pending_count(self):
        ...
        OfflineQueue.objects.create(object_id="b", action_type="CREATE", user=self.user, status="COMPLETED")
        OfflineQueue.objects.create(object_id="c", action_type="CREATE", user=self.user, status="PENDING")
        count = OfflineSyncService.get_pending_count()
    ...
    def test_pending_count_filtered_by_user(self):
        ...
        user2 = User.objects.create_user(
            email="user2@test.gov.ng", password="TestPass123!@#", first_name="User2", last_name="User", role="TCH"
        )
        OfflineQueue.objects.create(object_id="a", action_type="CREATE", user=self.user, status="PENDING")
        OfflineQueue.objects.create(object_id="b", action_type="CREATE", user=user2, status="PENDING")
...
class OfflineSyncServiceRetryTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email="retry@test.gov.ng", password="TestPass123!@#", first_name="Retry", last_name="User", role="TCH"
        )
...
class OfflineSyncServiceClearCompletedTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            email="clear@test.gov.ng", password="TestPass123!@#", first_name="Clear", last_name="User", role="TCH"
        )
    ...
    def test_clear_completed_removes_old_items(self):
        ...
        OfflineQueue.objects.filter(id=item.id).update(processed_at=timezone.now() - timezone.timedelta(days=31))
