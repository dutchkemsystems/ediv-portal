...
from .serializers import TranslateRequestSerializer, TranslationEntrySerializer, UserLanguagePreferenceSerializer
...
class TranslationViewSet(viewsets.ViewSet):
    ...
    def set_user_language(self, request):
        ...
        pref, _ = UserLanguagePreference.objects.update_or_create(
            user=request.user, defaults={"preferred_language": lang}
        )
