...
from .models import Class, Exam, Subject
...
class SubjectModelTest(TestCase):
    def setUp(self):
        self.subject = Subject.objects.create(name="Mathematics", code="MTH101", category="SCIENCE", is_compulsory=True)
...
class AcademicsAPITest(APITestCase):
    def setUp(self):
        ...
        self.subject = Subject.objects.create(name="Mathematics", code="MTH101", category="SCIENCE")
    ...
    def test_create_subject(self):
        data = {"name": "English Language", "code": "ENG101", "category": "GENERAL"}
