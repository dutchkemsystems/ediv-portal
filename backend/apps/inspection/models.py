...
class Inspection(models.Model):
    ...
    lead_inspector = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="led_inspections"
    )
...
class InspectionAction(models.Model):
    ...
    assigned_to = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, related_name="inspection_actions"
    )
