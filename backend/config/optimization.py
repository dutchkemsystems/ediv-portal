...
class CacheWarming:
    ...
    def warm_school_cache():
        ...
        schools = School.objects.filter(is_active=True).values("id", "name", "code", "school_type", "lga")
    ...
    def warm_department_cache():
        ...
        departments = Department.objects.filter(is_active=True).values("id", "name", "code", "category")
