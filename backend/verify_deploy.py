...
for attempt in range(10):
    ...
    if status in ("live", "succeeded"):
        ...
        print("Deploy FAILED. Check logs at dashboard.")
        break
...
print("\n=== FINAL HEALTH CHECK ===")
try:
    resp2 = requests.get("https://ediv-portal.onrender.com/health/", timeout=90)
    print(f"Health: {resp2.status_code} - {resp2.text[:200]}")
except Exception as e:
    print(f"Health check failed: {e}")
    print("Build may still be in progress. Check: https://dashboard.render.com/web/srv-da6u74gae00c73855d3g")

# If health passes, test all logins
try:
    health = requests.get("https://ediv-portal.onrender.com/health/", timeout=90)
